...
/****** Object:  StoredProcedure [dbo].[USP_capInv_IngestComsAllocation]    Script Date: 7/21/2017 2:19:00 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[USP_capInv_IngestComsAllocation]
/****************************************************************************************************
* Copyright REVENUE ANALYTICS 2017
* All Rights Reserved
*
* Created By: DATA ENGINEERING
* FileName:   USP_capInv_IngestComsAllocation.SQL
* Date:       04/07/2017
*
...
* Output(s):	CapInvRepository.dbo.CapInv_ML_Allocations
*
* Assumptions: ETLReopository.dbo.stg_coms_allocation table is updated
*
* Example Call: exec USP_capInv_IngestComsAllocation 0, @v_errorcode output
*
*
*****************************************************************************************************
* Notes:
